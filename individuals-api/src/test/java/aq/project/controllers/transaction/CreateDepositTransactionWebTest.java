...
//        Act & Assert
        webTestClient.post()
                .uri(PATH_CREATE_DEPOSIT_TRANSACTION)
    ...
    @Test
    @WithMockUser(username = "user", password = "pass")
    public void failCreateDepositTransactionOn5xxInternalServiceResponse() {
//        Arrange
        RateResponse rateResponse = getValidRateResponse();
...
//        Act & Assert
    ...
    @Test
    @WithMockUser(username = "user", password = "pass")
    public void failCreateDepositTransactionOn4xxInternalServiceResponse() {
//        Arrange
        RateResponse rateResponse = getValidRateResponse();
