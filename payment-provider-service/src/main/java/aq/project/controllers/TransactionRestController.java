...
public class TransactionRestController implements TransactionRestControllerApi {
    ...
    @Override
    public ResponseEntity<PaymentProviderServiceTransactionInfoResponseDto> getTransactionInfo(
            UUID id,
    ...
    @Override
    public ResponseEntity<List<PaymentProviderServiceTransactionInfoResponseDto>> getTransactionList(
