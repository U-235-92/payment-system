...
import aq.project.controllers.WebhookRestController;
...
@RestControllerAdvice(basePackageClasses = { WebhookRestController.class })
public class WebhookRestControllerExceptionHandler {
