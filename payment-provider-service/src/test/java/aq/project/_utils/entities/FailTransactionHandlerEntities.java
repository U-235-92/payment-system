...
public abstract class FailTransactionHandlerEntities {

    public static PaymentProviderServiceFailTransactionRequestDto getValidPaymentProviderServiceFailTransactionRequestDto() {
        PaymentProviderServiceFailTransactionRequestDto dto = new PaymentProviderServiceFailTransactionRequestDto();
    ...
    public static PaymentProviderServiceFailTransactionRequestDto getInvalidPaymentProviderServiceFailTransactionRequestDto() {
        PaymentProviderServiceFailTransactionRequestDto dto = new PaymentProviderServiceFailTransactionRequestDto();
