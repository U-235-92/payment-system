...
public class PersonRestController implements PersonRestControllerApi {
    ...
    public ResponseEntity<String> createPerson(CreateIndividualDataDTO createIndividualDataDTO) {
    ...
    public ResponseEntity<Void> deletePersonByKeycloakId(String keycloakId)  {
    ...
    public ResponseEntity<Void> undoDeletePerson(UndoOperationDTO undoOperationDTO) {
    ...
    public ResponseEntity<Void> updatePerson(UpdateIndividualDataDTO updateIndividualDataDTO) {
    ...
    public ResponseEntity<Void> undoUpdatePerson(UndoOperationDTO undoOperationDTO) {
        UndoOperation undoOperation = undoOperationDtoMapper.toUndoOperation(undoOperationDTO);
    ...
    public ResponseEntity<ResponseIndividualDataDTO> getPersonByKeycloakId(String keycloakId) {
