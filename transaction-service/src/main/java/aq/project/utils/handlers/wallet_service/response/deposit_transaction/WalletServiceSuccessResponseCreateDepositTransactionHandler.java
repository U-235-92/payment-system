...
public class WalletServiceSuccessResponseCreateDepositTransactionHandler {
    ...
    @Transactional
    @KafkaListener(topics = "wallet_service_create_deposit_transaction_response")
    public void handleSuccessResponseCreateTransactionOnWalletService(
            @NotNull @Valid WalletServiceDepositTransactionSuccessResponseDto walletServiceDepositTransactionSuccessResponseDto
    ) {
        UUID transactionId = walletServiceDepositTransactionSuccessResponseDto.getTransactionId();

        String traceId = walletServiceDepositTransactionSuccessResponseDto.getTraceId();
        ...
        String logMessageOnReceive = String.format(
                "Received success response of created deposit transaction with id: [%s] on wallet service",
                transactionId);
        ...
        try(Scope scope = span.makeCurrent()) {
            if(transactionServiceDepositTransactionOptional.isPresent()) {
                ...
                handleNotFoundTransactionServiceDepositTransaction(
                        walletServiceDepositTransactionSuccessResponseDto,
                        traceId,
                        spanId,
                        action
                );
    ...
    private void sendFailTransactionRequestWalletServiceDtoToKafka(
        ...
        try {
            String walletServiceFailTransactionRequestTopic = walletServiceKafkaProperties
                    .getTopic("wallet_service_fail_deposit_transaction_request");

            WalletServiceFailTransactionRequestDto walletServiceFailDepositTransactionRequestDto = walletServiceTransactionDtoMapper.toWalletServiceFailTransactionRequestDto(transactionServiceDepositTransaction);
            ...
            try {
                ...
                kafkaTemplate.send(walletServiceFailTransactionRequestTopic, walletServiceFailDepositTransactionRequestDto).get();
            } catch (ExecutionException | InterruptedException ex) {
                String logMessageOnError = String.format(
                        "Error occurred while sending fail [deposit] transaction request with transaction id: [%s] " +
                        "to kafka-topic: [%s] for service: [%s]",
    ...
    private void sendCancelTransactionRequestWalletServiceDtoToKafka(
        ...
        try {
            String walletServiceCancelTransactionRequestTopic = walletServiceKafkaProperties
                    .getTopic("wallet_service_cancel_deposit_transaction_request");

            WalletServiceCancelTransactionRequestDto walletServiceFailDepositTransactionRequestDto = walletServiceTransactionDtoMapper.toWalletServiceDepositTransactionRequestDto(transactionServiceDepositTransaction);
            ...
            try {
                ...
                kafkaTemplate.send(walletServiceCancelTransactionRequestTopic, walletServiceFailDepositTransactionRequestDto).get();
            } catch (ExecutionException | InterruptedException ex) {
                String logMessageOnError = String.format(
                        "Error occurred while sending cancel [deposit] transaction request with transaction id: [%s] " +
                        "to kafka-topic: [%s] for service: [%s]",
    ...
    private void handleNotFoundTransactionServiceDepositTransaction(
            WalletServiceDepositTransactionSuccessResponseDto depositTransactionResponseWalletServiceDto,
            String traceId,
            String spanId,
            String action
    ) {
        UUID transactionId = depositTransactionResponseWalletServiceDto.getTransactionId();
        ...
        sendFailTransactionRequestPaymentProviderServiceDtoToKafka(
                depositTransactionResponseWalletServiceDto,
                traceId,
                spanId,
                action
        );
    ...
    private void sendFailTransactionRequestPaymentProviderServiceDtoToKafka(
        ...
        try {
            ...
            PaymentProviderServiceFailTransactionRequestDto paymentProviderServiceFailTransactionRequestDto = paymentProviderTransactionDtoMapper.toPaymentProviderServiceFailTransactionRequestDto(depositTransactionResponseWalletServiceDto);
            paymentProviderServiceFailTransactionRequestDto.setOperation(Operation.DEPOSIT);
            paymentProviderServiceFailTransactionRequestDto.setMerchantId(merchantId);
    ...
    private void sendFailTransactionRequestWalletServiceDtoToKafka(
        ...
        try {
            ...
            WalletServiceFailTransactionRequestDto walletServiceFailDepositTransactionRequestDto = walletServiceTransactionDtoMapper.toWalletServiceFailTransactionRequestDto(depositTransactionResponseWalletServiceDto);
