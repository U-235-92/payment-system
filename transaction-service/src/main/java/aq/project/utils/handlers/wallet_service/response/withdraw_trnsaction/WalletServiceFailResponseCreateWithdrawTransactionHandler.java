...
public class WalletServiceFailResponseCreateWithdrawTransactionHandler {
    ...
    @Transactional
    @KafkaListener(topics = "wallet_service_create_withdraw_transaction_response_exceptions")
    public void handleErrorResponseCreateTransactionOnWalletService(
        ...
        String logMessageOnReceive = String.format(
                "Received error response of created withdraw transaction with id: [%s] on wallet service",
                transactionId);
