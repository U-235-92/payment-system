...
public class SendTransferTransactionRequestIntegrationTest {
    ...
    @Test
    public void successSendTransferTransactionRequestTest() {
        traceContext.setTraceId("4bf92f3577b34da6a3ce929d0e0e4736");
        Assertions.assertDoesNotThrow(() -> transactionService
                .sendTransactionRequest(TestTransferTransactionRequestMocks.getValidTransferMessageRequest()));
    }

    @Test
    public void failSendTransferTransactionRequestWithWrongDataTest() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> transactionService
                .sendTransactionRequest(TestTransferTransactionRequestMocks.getInvalidTransferMessageRequest()));
    }

    @Test
    public void failSendNullTransferTransactionRequestTest() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> transactionService
