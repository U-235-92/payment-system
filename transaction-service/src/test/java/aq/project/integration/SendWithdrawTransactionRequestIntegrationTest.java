...
public class SendWithdrawTransactionRequestIntegrationTest {
    ...
    @Test
    public void successSendWithdrawTransactionRequestTest() {
        Assertions.assertDoesNotThrow(() -> transactionService
                .sendTransactionRequest(TestWithdrawTransactionRequestMocks.getValidWithdrawMessageRequest()));
    }

    @Test
    public void failSendWithdrawTransactionRequestWithWrongDataTest() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> transactionService
                .sendTransactionRequest(TestWithdrawTransactionRequestMocks.getInvalidWithdrawMessageRequest()));
    }

    @Test
    public void failSendNullWithdrawTransactionRequestTest() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> transactionService
