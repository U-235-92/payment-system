...
public class GetTransferTransactionStatusWebTest {
...
//        Arrange
        ...
        TransactionServiceTransferTransaction savedTransaction = transactionServiceTransferTransactionRepository.save(transaction);

        UUID transactionId = savedTransaction.getId();

        String xTraceIdKey = "x-trace-id";
        String xTraceIdValue = UUID.randomUUID().toString();
        String endpoint = PATH_GET_TRANSFER_TRANSACTION_STATUS.replace("{id}", transactionId.toString());
