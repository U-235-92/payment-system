package aq.project.test.handlers.wsfrcdth.integration;
...
import static aq.project._utils.entities.wallet_service.WalletServiceFailResponseCreateDepositTransactionHandlerEntities.getInvalidWalletServiceTransactionErrorResponseDto;
...
public class HandleErrorResponseCreateTransactionOnWalletServiceIntegrationTest {
...
//        Act & Assert
    ...
    @Test
    public void failHandleErrorResponseCreateTransactionOnWalletServiceWhenReceivedInvalidWalletServiceTransactionErrorResponseDto() {
//        Arrange
        TransactionServiceDepositTransaction transactionServiceDepositTransaction = getValidTransactionServiceDepositTransaction();
        transactionServiceDepositTransaction.setId(null);
        transactionServiceDepositTransaction.setStatus(TransactionStatus.PENDING);
        ...
        WalletServiceTransactionErrorResponseDto walletServiceTransactionErrorResponseDto = getInvalidWalletServiceTransactionErrorResponseDto();

//        Act & Assert
        Assertions.assertThrows(ConstraintViolationException.class,
                () -> walletServiceFailResponseCreateDepositTransactionHandler
                    .handleErrorResponseCreateTransactionOnWalletService(walletServiceTransactionErrorResponseDto));
    ...
    @Test
    public void failHandleErrorResponseCreateTransactionOnWalletServiceWhenReceivedNullWalletServiceTransactionErrorResponseDto() {
//        Arrange
        TransactionServiceDepositTransaction transactionServiceDepositTransaction = getValidTransactionServiceDepositTransaction();
        transactionServiceDepositTransaction.setId(null);
        transactionServiceDepositTransaction.setStatus(TransactionStatus.PENDING);
        ...
        WalletServiceTransactionErrorResponseDto walletServiceTransactionErrorResponseDto = null;
