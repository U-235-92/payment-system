...
public class FailTransactionRequestHandler {
    ...
    public void handleFailDepositTransactionRequest(
        ...
        if(request != null) {
            ...
            String action = "handle-fail-deposit-transaction-request";
            ...
            String logMessageOnReceive = String.format(
                    "Received request to handle a fail deposit transaction with id: [%s]", transactionId);
            ...
            try(Scope scope = span.makeCurrent()) {
                if(isValidRequestDto(request, traceId, spanId, action)) {
                    ...
                    if(depositTransactionOptional.isPresent()) {
                        ...
                        TransactionStatus targetDepositTransactionStatus = TransactionStatus.FAILED;
                        ...
                        String logMessageOnException = String.format(
                                "Fail handle a fail deposit transaction request with transaction id: [%s]. " +
    ...
    public void handleFailWithdrawTransactionRequest(
        ...
        if(request != null) {
            ...
            String traceId = request.getTraceId();
            String action = "handle-fail-withdraw-transaction-request";
            String tracerName = serviceName + "." + action + "-tracer";
            ...
            String spanId = span.getSpanContext().getSpanId();
            String logMessageOnReceive = String.format(
                    "Received request to handle a fail withdraw transaction with id: [%s]", transactionId);
            ...
            try(Scope scope = span.makeCurrent()) {
                if(isValidRequestDto(request, traceId, spanId, action)) {
                    ...
                    if(withdrawTransactionOptional.isPresent()) {
                        ...
                        String logMessageOnException = String.format(
                                "Fail handle a fail withdraw transaction request with transaction id: [%s]. " +
                                "Transaction wasn't found",
                                transactionId);
    ...
    public void handleFailTransferTransactionRequest(
        ...
        if(request != null) {
            ...
            String traceId = request.getTraceId();
            String action = "handle-fail-transfer-transaction-request";
            String tracerName = serviceName + "." + action + "-tracer";
            ...
            String spanId = span.getSpanContext().getSpanId();
            String logMessageOnReceive = String.format(
                    "Received request to handle a fail transfer transaction with id: [%s]", transactionId);
            ...
            try(Scope scope = span.makeCurrent()) {
                if(isValidRequestDto(request, traceId, spanId, action)) {
                    ...
                    if(transferTransactionOptional.isPresent()) {
                        ...
                        String logMessageOnException = String.format(
                                "Fail handle a fail transfer transaction request with transaction id: [%s]. " +
                                "Transaction wasn't found",
                                transactionId);
