...
public class GetWalletCurrencyWebTest {

    private static final String GET_WALLET_CURRENCY_ENDPOINT = "/api/v1/wallet/currency/{id}";
    ...
    public void successGetWalletCurrency() throws Exception {
//        Arrange
        ...
        String endpoint = GET_WALLET_CURRENCY_ENDPOINT.replace("{id}", walletId.toString());
...
//        Act & Assert
    ...
    @Test
    @WithMockUser(username = "user", password = "secret")
    public void failGetWalletCurrencyOnNotFoundWalletId() throws Exception {
//        Arrange
        UUID walletId = UUID.randomUUID();
...
//        Act & Assert
    ...
    @Test
    public void failGetWalletCurrencyOnUnauthorizedRequest() throws Exception {
//        Arrange
        UUID walletId = UUID.randomUUID();
