...
public class GetWalletInfoWebTest {
    ...
    private static final String GET_WALLET_INFO_ENDPOINT = "/api/v1/wallet/info/{id}";
    ...
    public void successGetWalletInfo() throws Exception {
//        Arrange
        ...
        String endpoint = GET_WALLET_INFO_ENDPOINT.replace("{id}", walletId.toString());
...
//        Act & Assert
        mockMvc.perform(get(endpoint)) // Отсутствует заголовок x-trace-id
                .andExpect(status().isBadRequest());
    }

    @Test
    @WithMockUser(username = "user", password = "secret")
    public void failGetWalletInfoOnNotFoundWalletId() throws Exception {
//        Arrange
        UUID walletId = UUID.randomUUID();
...
//        Act & Assert
    ...
    @Test
    public void failGetWalletInfoOnUnauthorizedRequest() throws Exception {
//        Arrange
        UUID walletId = UUID.randomUUID();
